...
export function TabItem({ value, title, isSelected }: TabItemProps) {
  return (
    <Tabs.Trigger
      value={value}
      className='group relative px-1 pb-4 text-sm font-medium text-zinc-400 outline-none hover:text-violet-700 data-[state=active]:text-violet-900 dark:text-zinc-300 dark:hover:text-violet-300 dark:data-[state=active]:text-violet-300'>
